...
def test_generate_diff():
    assert generate_diff('tests/test_data/file1.json', 'tests/test_data/file2.json') == read_file_test('tests/test_data/expectation_diff.txt')
    assert generate_diff('tests/test_data/file1.json', 'tests/test_data/file2.yaml') == read_file_test('tests/test_data/expectation_diff.txt')
    assert generate_diff('tests/test_data/test_file1.json', 'tests/test_data/test_file2.json') == read_file_test('tests/test_data/expect_diff.txt')
