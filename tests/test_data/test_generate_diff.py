...
def read_file_test2():
    with open('tests/test_data/expect_diff.txt', 'r') as file:
        data = file.read()
        return data    
...
def test_generate_diff():
    ...
    assert generate_diff('tests/test_data/test_file1.json', 'tests/test_data/test_file2.json') == read_file_test2()
